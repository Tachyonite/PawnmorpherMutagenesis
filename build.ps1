...
dotnet restore "Source/PawnmorpherMutagenesis/PawnmorpherMutagenesis.sln"
...
."C:\Program Files (x86)\Microsoft Visual Studio\$VSVersion\Community\MSBuild\Current\Bin\MSBuild.exe"  "Source/PawnmorpherMutagenesis/PawnmorpherMutagenesis.sln" /t:restore
...
."C:\Program Files (x86)\Microsoft Visual Studio\$VSVersion\Community\MSBuild\Current\Bin\MSBuild.exe"  "Source/PawnmorpherMutagenesis/PawnmorpherMutagenesis.sln" /t:Rebuild /p:Configuration=Debug /p:Platform="any cpu"
...
if (Test-Path "$buildDir/Tmp/Source/PawnmorpherMutagenesis/.vs") {
    Remove-Item "$buildDir/Tmp/Source/PawnmorpherMutagenesis/.vs" -Recurse -Force
}
#get rid of nuget packages

if (Test-Path "$buildDir/Tmp/Source/PawnmorpherMutagenesis/packages") {
    Remove-Item "$buildDir/Tmp/Source/PawnmorpherMutagenesis/packages" -Force -Recurse
}
